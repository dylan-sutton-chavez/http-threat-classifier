## 3. Using the Model for OWASP Detection
...
### 3.1 Class Separability and Perceptron Convergence in High Dimensions
...
### 3.2 LLM-Assisted Geometric Active Perceptron (L-GAP)
...
### 3.3 Context in a Simple Perceptron
...
### 3.4 Payload Vectorization with Character N-gram Hashing
