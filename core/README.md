...
model_metadata = {
    'model_name': "Gate OR Simple Perceptron", 
...
cache_id = simple_perceptron.train(epochs=30, patience=3, labeled_dataset_path=gate_or_root, learning_rate=0.65, model_metadata=model_metadata)
```
...
```bash
Epoch 1/30
    Weights: [0.5380756924598852, 0.5712330024598851] | Bias: 0.65523779 | Error: 0.75 | Time: 0.0284
Epoch 2/30
    Weights: [0.5380756924598852, 0.5712330024598851] | Bias: 0.65523779 | Error: 0.0 | Time: 0.01610001
Epoch 3/30
    Weights: [0.5380756924598852, 0.5712330024598851] | Bias: 0.65523779 | Error: 0.0 | Time: 0.0147
Epoch 4/30
    Weights: [0.5380756924598852, 0.5712330024598851] | Bias: 0.65523779 | Error: 0.0 | Time: 0.0153
Early Stopping
Model saved as `gate-or-simple-perceptron.2025_10_30.json`
```
...
model_metadata = {
    'model_name': "Gate OR Simple Perceptron Tuned", 
    'description': "Fine-tuned simple perceptron using the gate `OR`", 
    'author': "Dylan Sutton Chavez"
}

# past model full root
past_model_root = complete_root(root_dir, ["test", "gate-or-simple-perceptron.2025_10_30.json"])

# make fine-tuning to the past model
simple_perceptron.fine_tuning(epochs=10, patience=2, labeled_dataset_path=gate_or_root, learning_rate=0.65, past_model_path=past_model_root, model_metadata=model_metadata)
```
...
```bash
Epoch 1/10
    Weights: [0.5384657924598851, 0.5640696324598853] | Bias: 0.64417612 | Error: 0.0 | Time: 0.0096
Epoch 2/10
    Weights: [0.5384657924598851, 0.5640696324598853] | Bias: 0.64417612 | Error: 0.0 | Time: 0.01419999
Early Stopping
Model saved as `gate-or-simple-perceptron-tuned.2025_10_30.json`
```
