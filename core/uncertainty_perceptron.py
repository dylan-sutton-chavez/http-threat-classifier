...
from core.perceptron_cache import ModelCache, TrainingInfo

vector_switch = 20 # initialize the `vector switch` constant
...
class SimplePerceptron:
    ...
    def _calculate_net_input(self, input_features: list[float], cache_id: int):
        ...
        if len(input_features) >= vector_switch:
...
if __name__ == "__main__":
    ...
    output:
        models are saved in the run path; history moved to ../core/test/
    """
    ...
    cache_id = simple_perceptron.train(epochs=30, patience=3, labeled_dataset_path='core/test/gate_or.json', learning_rate=0.65, model_metadata=model_metadata)
    ...
    simple_perceptron.fine_tuning(epochs=10, patience=2, labeled_dataset_path='core/test/gate_or.json', learning_rate=0.65, past_model_path='core/test/gate-or-simple-perceptron.2025_10_30.json', model_metadata=model_metadata)