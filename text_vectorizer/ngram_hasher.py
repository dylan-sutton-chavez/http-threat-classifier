...
if __name__ == '__main__':
    ...
    payload = "Machine learning is the study of algorithms that improve their performance at a task through experience with data, enabling computers to identify patterns and make predictions without explicit programming for each scenario."
    salt = randbits(384) # generate a random salt (384 bits)

    window_perceptron = NGramHashVectorizer(salt, 10, 7) # initialize the slicer vectorizer
